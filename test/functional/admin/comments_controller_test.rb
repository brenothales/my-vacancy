...
class Admin::CommentsControllerTest < ActionController::TestCase
  ...
  test "should create admin_comment" do
    assert_difference('Admin::Comment.count') do
      post :create, admin_comment: { content: @admin_comment.content, email: @admin_comment.email, name: @admin_comment.name }
    end
  ...
  test "should update admin_comment" do
    put :update, id: @admin_comment, admin_comment: { content: @admin_comment.content, email: @admin_comment.email, name: @admin_comment.name }
    assert_redirected_to admin_comment_path(assigns(:admin_comment))
  end
